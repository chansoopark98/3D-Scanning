...
down_voxel_size = 0.1
# icp 15 , 1.5 no
icp_distance = down_voxel_size * 30
result_color_distance = down_voxel_size * 3.0
result_icp_distance = down_voxel_size * 2.0
...
def registerLocalCloud(target, source):
        ...
        result_icp = o3d.pipelines.registration.registration_colored_icp(source_temp, target_temp, result_color_distance,
                p2l_init_trans_guess,  o3d.pipelines.registration.TransformationEstimationForColoredICP(),
                )

        result_icp = o3d.pipelines.registration.registration_icp(
            source_temp, target_temp, result_icp_distance, result_icp.transformation,
